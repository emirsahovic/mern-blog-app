                        ...
                        <div className="mt-4">
                            <div className="mt-4">
                                ...
                                <input type="email" placeholder="Email"
                                    className="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-sky-600"
                                    name="email"
                                    value={email}
                                    onChange={onChange}
                                    required
                            ...
                            <div className="flex">
                                <button type='submit' className="w-full px-6 py-2 mt-4 text-white bg-sky-500 rounded-lg hover:bg-sky-700 transition duration-200">
                                    Sign In
                                </button>
                            </div>
